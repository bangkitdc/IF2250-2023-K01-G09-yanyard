...
"}")
        ...
        self.grid_layout_tanaman.setColumnStretch(1, 1)
        self.grid_layout_tanaman.setColumnStretch(1, 1)  # new column
    ...
    "}")
            ...
            self.label_name.setText("Strobeyi")
    ...
    "}")
            ...
            self.label_date.setText("since March 2023")
        ...
        self.add_btn.setGeometry(QtCore.QRect(740, 520, 170, 42))
